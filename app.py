...
def predict():
    ...
    API_KEY = "rCiQXQwIxLy0Im9T2sdSWB6MVgg088tFC5gun6FMnIdj"
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/b6d891fc-5711-45d5-a23a-3e02d7c59038/predictions?version=2022-06-27', json=payload_scoring,
